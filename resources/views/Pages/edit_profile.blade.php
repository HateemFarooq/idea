        ...
        <div class="bg-[#0D0D0D] border border-white/5 rounded-3xl p-10 shadow-2xl">
            ...
            <form action="{{ route('profile.update') }}" method="POST" class="space-y-5">
                ...
                <div class="pt-4">
                    ...
                    <h2 class="text-xs uppercase tracking-widest font-bold text-gray-400 mb-4">Security Verification</h2>
                </div>

                <div>
                    <label class="block mb-2 text-xs uppercase tracking-widest font-semibold text-gray-500">Current Password *</label>
