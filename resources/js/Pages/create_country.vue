...
function submit() {
  router.post('/admin/countries/store', { name: name.value }, {
    ...
    <main class="main-content">
        ...
        <div class="header-title">
          <div class="title-with-icon">
            ...
            <div>
              ...
              <p>Expand the community database with new global locations.</p>
            </div>
          </div>
        </div>
      ...
      <div class="form-card card-single">
        <div class="form-group">
          <label for="name" class="input-label">Country Name</label>
          <input 
            id="name"
            v-model="name" 
            type="text" 
