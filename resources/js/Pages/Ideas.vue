...
function deleteIdea() {
  router.delete(`/admin/ideas/${selectedIdea.value.id}`, {
    onSuccess: () => {
  ...
  <div class="admin-layout">
    ...
    <main class="main-content">
      ...
      <div class="table-tools">
        <input v-model="search" type="text" placeholder="Search ideas..." class="search-input" />
      </div>
      <div class="table-card">
        <div class="table-responsive">
              ...
              <tr v-for="idea in ideas.data" :key="idea.id">
                ...
                <td>
                  <div v-if="idea.links?.length" class="links-wrapper">
                    <a v-for="(link, index) in idea.links" :key="index" :href="link" target="_blank" class="icon-link"
                      title="Open Link">
          ...
          <div class="pagination">
            <button v-for="link in ideas.links" :key="link.label" v-html="link.label" :disabled="!link.url"
      ...
      <div v-if="showDeleteModal" class="modal-overlay">
        <div class="modal-box">
          ...
          <div class="modal-actions">
            ...
            <button class="confirm-btn" @click="deleteIdea">Delete</button>
          </div>
        </div>
      </div>
    </main>
